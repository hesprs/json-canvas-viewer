...
<body></body>
<script type="module">
    import { CanvasViewer } from 'https://unpkg.com/json-canvas-viewer/dist/chimp.js';
</script>
</html>
```
...
```JavaScript
import { CanvasViewer, parser, loadCanvas, Minimap } from 'https://unpkg.com/json-canvas-viewer/dist/chimp.js';
